...
(function (factory) {
  ...
  })('<0 6="5-container"><0 6="5-canvas"></0><0 6="5-2-9" 3-2="move"></0><0 6="5-crop-9"><1 6="5-view-9"></1><1 6="5-8 8-h"></1><1 6="5-8 8-v"></1><1 6="5-face" 3-2="all"></1><1 6="5-7 7-e" 3-2="e"></1><1 6="5-7 7-n" 3-2="n"></1><1 6="5-7 7-w" 3-2="w"></1><1 6="5-7 7-s" 3-2="s"></1><1 6="5-4 4-e" 3-2="e"></1><1 6="5-4 4-n" 3-2="n"></1><1 6="5-4 4-w" 3-2="w"></1><1 6="5-4 4-s" 3-2="s"></1><1 6="5-4 4-ne" 3-2="ne"></1><1 6="5-4 4-nw" 3-2="nw"></1><1 6="5-4 4-sw" 3-2="sw"></1><1 6="5-4 4-se" 3-2="se"></1></0></0>', 'div,span,drag,order,point,cropper,class,line,dashed,box');

  /* Template source:
  <div class="cropper-container">
    <div class="cropper-canvas"></div>
    <div class="cropper-drag-box" order-drag="move"></div>
    <div class="cropper-crop-box">
      <span class="cropper-view-box"></span>
      <span class="cropper-dashed dashed-h"></span>
      <span class="cropper-dashed dashed-v"></span>
      <span class="cropper-face" order-drag="all"></span>
      <span class="cropper-line line-e" order-drag="e"></span>
      <span class="cropper-line line-n" order-drag="n"></span>
      <span class="cropper-line line-w" order-drag="w"></span>
      <span class="cropper-line line-s" order-drag="s"></span>
      <span class="cropper-point point-e" order-drag="e"></span>
      <span class="cropper-point point-n" order-drag="n"></span>
      <span class="cropper-point point-w" order-drag="w"></span>
      <span class="cropper-point point-s" order-drag="s"></span>
      <span class="cropper-point point-ne" order-drag="ne"></span>
      <span class="cropper-point point-nw" order-drag="nw"></span>
      <span class="cropper-point point-sw" order-drag="sw"></span>
      <span class="cropper-point point-se" order-drag="se"></span>
    </div>
  </div>
  */
